...
func GetDashBoard3Content() (types.Panel, error) {
	...
	ecbox := components.Box().WithHeadBorder(true).SetHeader("查询时间对比 哈希表 vs 二分查找").SetBody(echart.SetContent(line).GetContent()).GetContent()
	...
	ecbox2 := components.Box().WithHeadBorder(true).SetHeader("Bar-多 Y 轴").SetBody(echart.SetContent(bar).GetContent()).GetContent()
	...
	ecbox3 := components.Box().WithHeadBorder(true).SetHeader("Bar3D-示例图").SetBody(echart.SetContent(bar3d).GetContent()).GetContent()
	...
	ecbox4 := components.Box().WithHeadBorder(true).SetHeader("BoxPlot-示例图").SetBody(echart.SetContent(bp).GetContent()).GetContent()
