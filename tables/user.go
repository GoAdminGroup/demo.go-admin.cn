...
func GetUserTable(ctx *context.Context) (userTable table.Table) {
	...
	info.AddColumnButtons(ctx, "查看更多", types.GetColumnButton("更多", icon.Info,
	...
	info.AddActionButton(ctx, "审批", action.Ajax("/admin/audit",
	...
	info.AddButton(ctx, "jump", icon.User, action.JumpInNewTab("/admin/info/authors", "作者"))
	...
	info.AddSelectBox(ctx, "性别", types.FieldOptions{
		{Value: "0", Text: "男"},
		{Value: "1", Text: "女"},
